...
const Services = () => {
  ...
  return (
    <SectionWrapper id="services">
      ...
      <div className="flex flex-col lg:flex-row gap-6 sm:gap-10 lg:gap-5 animate-fadeInUp">
        ...
        <div className="lg:min-w-[30rem] lg:max-w-[30rem] mt-6 sm:mt-8 lg:mt-0 bg-white/90 rounded-2xl shadow-xl p-4 sm:p-6 animate-fadeIn">
          <h3 className="text-lg sm:text-2xl font-bold mb-2 sm:mb-4 text-primary">
            {selectedServiceData?.heading}
          </h3>
          <div className="lg:ml-5 min-h-[20rem] sm:min-h-[33.4375rem]">
            <h4 className="text-base sm:text-xl font-semibold mb-2 sm:mb-4 text-gray-700">
              {selectedServiceData?.subheading}
            </h4>
            <ul className="grid grid-cols-1 gap-2 sm:gap-4 md:gap-6 mb-4 sm:mb-6">
